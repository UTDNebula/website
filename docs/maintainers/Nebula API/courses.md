...
Courses lay one level of abstraction above sections in the academic hierarchy at UTD. A course represents a class offered by a school at UTD. A course can have multiple sections associated with it every semester. An example of a course would be ECS1100.
...
| offering_frequency       | string                                                                                                | true     | none         | The frequency of offering a course                                                                                  |
...
> :warning: **If no query parameters are provided, the API will return every course in the entire data set. Be very careful when attempting to make large queries like this!**
